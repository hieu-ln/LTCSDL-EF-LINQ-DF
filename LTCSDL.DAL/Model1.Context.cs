...
namespace LTCSDL.DAL
{
    ...
    public partial class NorthwindEntities2 : DbContext
    {
        ...
        [DbFunction("NorthwindEntities2", "func_getProductByPrice")]
        public virtual IQueryable<func_getProductByPrice_Result> func_getProductByPrice(Nullable<decimal> fromAmt, Nullable<decimal> toAmt)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<func_getProductByPrice_Result>("[NorthwindEntities2].[func_getProductByPrice](@fromAmt, @toAmt)", fromAmtParameter, toAmtParameter);
        }
